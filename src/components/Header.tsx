...
import { BookOpen, Cpu, Download, Sparkles, Github, Eye, ExternalLink } from 'lucide-react';
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
          {onOpenTestPage && (
            <button
              ...
              title="Test view count registering in real time"
            >
              <Eye className="w-3.5 h-3.5 text-[#B4F82C]" />
